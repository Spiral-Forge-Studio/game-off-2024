...
public class RocketExplosionRadiusBuff : Buff
{
    ...
    public RocketExplosionRadiusBuff(PlayerStatusSO status, float duration, BuffType buffType, Rarity rarity, float initialAmount, float consecutiveAmount, float scalingFactor)
        : base(duration)
    {
    ...
    public override void ApplyBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.RocketExplosionRadiusFlatBonus, initialAmountFlat);
    ...
    public override void ApplyConsecutiveBuff()
    {
        if (buffType == BuffType.Flat)
        {
            ...
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.RocketExplosionRadiusFlatBonus, bonusAmount);
    ...
    public override void RemoveBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.RocketExplosionRadiusFlatBonus, -totalFlatBonus);
        }
        if (buffType == BuffType.Percentage)
        {
