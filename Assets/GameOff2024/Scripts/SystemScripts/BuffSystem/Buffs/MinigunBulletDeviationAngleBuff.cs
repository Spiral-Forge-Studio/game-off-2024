...
public class MinigunBulletDeviationAngleBuff : Buff
{
    ...
    public MinigunBulletDeviationAngleBuff(PlayerStatusSO status, float duration, BuffType buffType, Rarity rarity, float initialAmount, float consecutiveAmount, float scalingFactor)
        : base(duration)
    {
    ...
    public override void ApplyBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunBulletDeviationAngleBonus, initialAmountFlat);
    ...
    public override void ApplyConsecutiveBuff()
    {
        if (buffType == BuffType.Flat)
        {
            ...
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunBulletDeviationAngleBonus, reductionAmount);
    ...
    public override void RemoveBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunBulletDeviationAngleBonus, -totalFlatReduction);
        }
        if (buffType == BuffType.Percentage)
        {
