...
public class RocketReloadTimeBuff : Buff
{
    ...
    public RocketReloadTimeBuff(PlayerStatusSO status, float duration, BuffType buffType, Rarity rarity, float initialAmount, float consecutiveAmount, float scalingFactor)
        : base(duration)
    {
