...
public class MinigunCritDamageBuff : Buff
{
    ...
    public MinigunCritDamageBuff(PlayerStatusSO status, float duration, BuffType buffType, Rarity rarity, float initialAmount, float consecutiveAmount, float scalingFactor)
        : base(duration)
    {
    ...
    public override void ApplyBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunCritDamageFlatBonus, initialAmountFlat);
    ...
    public override void ApplyConsecutiveBuff()
    {
        if (buffType == BuffType.Flat)
        {
            ...
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunCritDamageFlatBonus, reductionAmount);
    ...
    public override void RemoveBuff(GameObject target)
    {
        if (buffType == BuffType.Flat)
        {
            playerStatus.ModifyFlatBonus(EStatTypeFlatBonus.MinigunCritDamageFlatBonus, -totalFlatReduction);
        }
        if (buffType == BuffType.Percentage)
        {
