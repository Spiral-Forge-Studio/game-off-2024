...
public class RocketCritRateBuff : Buff
{
    ...
    public float initialAmountFlat = 0.06f; // Reduced deviation (negative value for reduction)
    public float initialAmountMultiplier = 60f; // Percentage-based reduction
